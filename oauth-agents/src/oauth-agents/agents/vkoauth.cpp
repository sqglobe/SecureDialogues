...
VkOauth::VkOauth(const std::string &clientId, const std::string &redirectUri): mClientId(clientId), mRedirectUri(redirectUri)
{

}

VkOauth::VkOauth(const std::string &clientId, const std::string &redirectUri, const std::string &accessToken):
...
std::pair<std::string, std::string> VkOauth::getAuthParam() const
{
    return std::make_pair<std::string, std::string>(
                "access_token", std::string(mAccessToken));
}
