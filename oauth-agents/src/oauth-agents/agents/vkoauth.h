...
public:
    ...
    VkOauth(const std::string &clientId, const std::string &redirectUri, const std::string &accessToken);

public:
 virtual std::string getUserUrl() const override;
 virtual void loadAccessToken(const std::string& userCode) noexcept(false) override;
