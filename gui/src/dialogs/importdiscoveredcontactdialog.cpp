...
ImportDiscoveredContactDialog::ImportDiscoveredContactDialog(
    ...
    QWidget* parent) :
    TranslateChangeEventHandler<QDialog, Ui::ImportDiscoveredContactDialog>(
        parent),
    ui(new Ui::ImportDiscoveredContactDialog), mWidget(std::move(widget)),
...
void ImportDiscoveredContactDialog::onShowRecievedContact(
    std::string dialogId) {
