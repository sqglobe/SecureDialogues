...
DialogCreation::DialogCreation(std::shared_ptr<ContactModel> model,
                               ...
                               QWidget* parent) :
    TranslateChangeEventHandler<QDialog, Ui::DialogCreation>(parent),
...
void DialogCreation::on_buttonBox_accepted() {
  ...
  if (!index.isValid()) {
    QMessageBox::critical(this, tr("Error!"),
                          tr("Your have to select one of the connections to "
    ...
    try {
      ...
      auto res =
          QMessageBox::question(this, tr("Choice required"),
      ...
      QMessageBox::critical(
          this, tr("Error!"),
          tr("Error occured during dialog creation: ") + ex.what());
    }
  }
}
